...
def d3_path_finder(n):
   ...
   #for path_option in abc_path_columns[n - 1][share]:
   path_option = 'abc'
   if path_option in acb_path_columns[n - 1][share] and \
      path_option in bac_path_columns[n - 1][share] and \
      path_option in bca_path_columns[n - 1][share] and \
      path_option in cab_path_columns[n - 1][share] and \
      path_option in cba_path_columns[n - 1][share]:
      if (abc_path_columns[n - 1][share][path_option], \
          acb_path_columns[n - 1][share][path_option], \
          bac_path_columns[n - 1][share][path_option], \
          bca_path_columns[n - 1][share][path_option], \
          cab_path_columns[n - 1][share][path_option], \
          cba_path_columns[n - 1][share][path_option]) not in combined_columns[n - 1]:
         combined_columns[n - 1][(abc_path_columns[n - 1][share][path_option], \
                                  acb_path_columns[n - 1][share][path_option], \
                                  bac_path_columns[n - 1][share][path_option], \
                                  bca_path_columns[n - 1][share][path_option], \
                                  cab_path_columns[n - 1][share][path_option], \
                                  cba_path_columns[n - 1][share][path_option])] = {}
      combined_columns[n - 1][(abc_path_columns[n - 1][share][path_option], \
                               acb_path_columns[n - 1][share][path_option], \
                               bac_path_columns[n - 1][share][path_option], \
                               bca_path_columns[n - 1][share][path_option], \
                               cab_path_columns[n - 1][share][path_option], \
                               cba_path_columns[n - 1][share][path_option])][path_option] = (share, share, share, share, share, share)
   for i in range(n - 2, -1, -1):
      for so_far_path in combined_columns[i + 1]:
         for path_option in abc_path_columns[i][so_far_path[0]]:
            if path_option in acb_path_columns[i][so_far_path[1]] and \
               path_option in bac_path_columns[i][so_far_path[2]] and \
               path_option in bca_path_columns[i][so_far_path[3]] and \
               path_option in cab_path_columns[i][so_far_path[4]] and \
               path_option in cba_path_columns[i][so_far_path[5]]:
               if (abc_path_columns[i][so_far_path[0]][path_option], \
                   acb_path_columns[i][so_far_path[1]][path_option], \
                   bac_path_columns[i][so_far_path[2]][path_option], \
                   bca_path_columns[i][so_far_path[3]][path_option], \
                   cab_path_columns[i][so_far_path[4]][path_option], \
                   cba_path_columns[i][so_far_path[5]][path_option]) not in combined_columns[i]:
                  combined_columns[i][(abc_path_columns[i][so_far_path[0]][path_option], \
                                       acb_path_columns[i][so_far_path[1]][path_option], \
                                       bac_path_columns[i][so_far_path[2]][path_option], \
                                       bca_path_columns[i][so_far_path[3]][path_option], \
                                       cab_path_columns[i][so_far_path[4]][path_option], \
                                       cba_path_columns[i][so_far_path[5]][path_option])] = {}
               combined_columns[i][(abc_path_columns[i][so_far_path[0]][path_option], \
                                    acb_path_columns[i][so_far_path[1]][path_option], \
                                    bac_path_columns[i][so_far_path[2]][path_option], \
                                    bca_path_columns[i][so_far_path[3]][path_option], \
                                    cab_path_columns[i][so_far_path[4]][path_option], \
                                    cba_path_columns[i][so_far_path[5]][path_option])][path_option] = \
                                    (so_far_path[0], \
                                     so_far_path[1], \
                                     so_far_path[2], \
                                     so_far_path[3], \
   ...
   #print(combined_columns)
   #print(share)
   return d3_path_recursive(n, (0, 0, 0, 0, 0, 0), combined_columns)
...
def d3_path_recursive(n, shares, combined_columns, depth=0, so_far=''):
   solutions = []
   for possibility in combined_columns[depth][shares]:
      if depth == n - 1:
         if possibility == 'abc':
            solutions.append(possibility + so_far)
      else:
         solutions.extend(d3_path_recursive(n, combined_columns[depth][shares][possibility], combined_columns, depth=depth + 1, so_far=possibility + so_far))
   return solutions
