                        ...
                        0:    {1:{1:{a + c + b + d + e:(0, 0, 0), \
                               ...
                               0:{1:{a + b + d + c + e:(0, 0, 0), \
                                  ...
                                  0:{a + b + c + e + d:(0, 0, 0), \
                                     ...
                                     e + d + c + a + b:(0, 0, 0), \
                                     e + d + c + b + a:(0, 0, 0)}}}})
   path_lengths.append({n:{1:{1:1}}, n - 1:{1:{1:4}}, 0:{1:{1:15}, 0:{1:40, 0:60}}})
   #path_columns.append({0:    {0:{0:{a + b + c + d + e:(0, 0, 0)}}}})
   for i in range(n - 1):
      path_columns.append({})
      path_lengths.append({})
      #                    group,             num_as_bcd_es,         num_as_bc,   num_as_b,    num_cd_es, num_d_es, previous_path_column, current_path_column, previous_path_length, current_path_length
      d5_path_column_maker(a + b + c + d + e, (n - i - 1) * (i + 2), (n - i - 1), (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + b + c + e + d, (n - i - 1) * (i + 1), (n - i - 1), (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + b + d + c + e, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + b + d + e + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + b + e + c + d, (n - i - 1) * (i + 1), (n - i - 1), (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + b + e + d + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + c + b + d + e, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + c + b + e + d, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + c + d + b + e, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + c + d + e + b, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + c + e + b + d, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + c + e + d + b, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + d + b + c + e, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + d + b + e + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + d + c + b + e, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + d + c + e + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + d + e + b + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + d + e + c + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + e + b + c + d, (n - i - 1) * (i + 1), (n - i - 1), (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + e + b + d + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + e + c + b + d, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + e + c + d + b, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + e + d + b + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(a + e + d + c + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + a + c + d + e, (n - i - 2) * (i + 2), (n - i - 2), (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + a + c + e + d, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + a + d + c + e, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + a + d + e + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + a + e + c + d, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + a + e + d + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + c + a + d + e, (n - i - 2) * (i + 2), (n - i - 2), (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + c + a + e + d, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + c + d + a + e, (n - i - 2) * (i + 2), (n - i - 2), (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + c + d + e + a, (n - i - 2) * (i + 2), (n - i - 2), (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + c + e + a + d, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + c + e + d + a, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + d + a + c + e, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + d + a + e + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + d + c + a + e, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + d + c + e + a, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + d + e + a + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + d + e + c + a, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + e + a + c + d, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + e + a + d + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + e + c + a + d, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + e + c + d + a, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + e + d + a + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(b + e + d + c + a, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + a + b + d + e, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + a + b + e + d, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + a + d + b + e, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + a + d + e + b, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + a + e + b + d, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + a + e + d + b, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + b + a + d + e, 0                    , 0          , (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + b + a + e + d, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + b + d + a + e, 0                    , 0          , (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + b + d + e + a, 0                    , 0          , (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + b + e + a + d, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + b + e + d + a, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + d + a + b + e, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + d + a + e + b, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + d + b + a + e, 0                    , 0          , (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + d + b + e + a, 0                    , 0          , (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + d + e + a + b, 0                    , 0          , (n - i - 1), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + d + e + b + a, 0                    , 0          , (n - i - 2), (i + 2),   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + e + a + b + d, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + e + a + d + b, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + e + b + a + d, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + e + b + d + a, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + e + d + a + b, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(c + e + d + b + a, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + a + b + c + e, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + a + b + e + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + a + c + b + e, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + a + c + e + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + a + e + b + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + a + e + c + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + b + a + c + e, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + b + a + e + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + b + c + a + e, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + b + c + e + a, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + b + e + a + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + b + e + c + a, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + c + a + b + e, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + c + a + e + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + c + b + a + e, 0                    , 0          , (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + c + b + e + a, 0                    , 0          , (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + c + e + a + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + c + e + b + a, 0                    , 0          , (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + e + a + b + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + e + a + c + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + e + b + a + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + e + b + c + a, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + e + c + a + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(d + e + c + b + a, 0                    , 0          , (n - i - 2), 0      ,   (i + 2),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + a + b + c + d, (n - i - 1) * (i + 1), (n - i - 1), (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + a + b + d + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + a + c + b + d, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + a + c + d + b, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + a + d + b + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + a + d + c + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + b + a + c + d, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + b + a + d + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + b + c + a + d, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + b + c + d + a, (n - i - 2) * (i + 1), (n - i - 2), (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + b + d + a + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + b + d + c + a, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + c + a + b + d, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + c + a + d + b, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + c + b + a + d, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + c + b + d + a, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + c + d + a + b, 0                    , 0          , (n - i - 1), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + c + d + b + a, 0                    , 0          , (n - i - 2), (i + 1),   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + d + a + b + c, 0                    , (n - i - 1), (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + d + a + c + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + d + b + a + c, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + d + b + c + a, 0                    , (n - i - 2), (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + d + c + a + b, 0                    , 0          , (n - i - 1), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
      d5_path_column_maker(e + d + c + b + a, 0                    , 0          , (n - i - 2), 0      ,   (i + 1),  path_columns[i],      path_columns[i + 1], path_lengths[i], path_lengths[i + 1])
   return path_columns, path_lengths

def d5_path_column_maker(group, num_as_bcd_es, num_as_bc, num_as_b, num_cd_es, num_d_es, previous_path_column, current_path_column, previous_path_length, current_path_length):
   for path_num in previous_path_column:
      for path_cde_num in previous_path_column[path_num]:
         for path_de_num in previous_path_column[path_num][path_cde_num]:
            ...
            if total not in current_path_length:
               current_path_length[total] = {}
            if so_far_cde not in current_path_column[total]:
               current_path_column[total][so_far_cde] = {}
            if so_far_cde not in current_path_length[total]:
               current_path_length[total][so_far_cde] = {}
            if so_far_de not in current_path_column[total][so_far_cde]:
               current_path_column[total][so_far_cde][so_far_de] = {}
            if so_far_de not in current_path_length[total][so_far_cde]:
               current_path_length[total][so_far_cde][so_far_de] = 0
            ...
            current_path_length[total][so_far_cde][so_far_de] += previous_path_length[path_num][path_cde_num][path_de_num]


def d5_path_finder(n):
   share = pow(n, 5) / math.factorial(5)
   share_cde = pow(n, 3) / math.factorial(3)
   share_de = pow(n, 2) / math.factorial(2)
   abcde_path_columns, abcde_path_lengths = d5_path_maker(n, 'a', 'b', 'c', 'd', 'e')
   print(abcde_path_lengths[n - 1][share][share_cde][share_de])
   return []
