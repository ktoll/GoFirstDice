...
def d4_path_maker(n, a, b, c, d): #n is for number of sides of dice
   ...
   path_columns.append({0:{a + b + d + c:(0, 0), a + d + b + c: (0, 0), a + d + c + b:(0, 0), b + a + d + c:(0, 0), b + d + a + c:(0, 0), b + d + c + a:(0, 0), d + a + b + c:(0, 0), d + a + c + b:(0, 0), d + b + a + c:(0, 0), d + b + c + a:(0, 0), d + c + a + b:(0, 0), d + c + b + a:(0, 0), a + c + b + d:(0, 1), a + c + d + b:(0, 1), c + a + b + d:(0, 1), c + a + d + b:(0, 1), c + b + a + d:(0, 1), c + b + d + a:(0, 1), c + d + a + b:(0, 1), c + d + b + a:(0, 1)}, n - 1:{b + a + c + d:(0, 1), b + c + a + d:(0, 1), b + c + d + a:(0, 1)}, n:{a + b + c + d:(0, 1)}})
   for i in range(n - 1):
      path_columns.append({})
...
#i = 0
#for path_column in d4_path_maker(18, 'a', 'b', 'c', 'd'):
#   print(i)
#   n = 0
